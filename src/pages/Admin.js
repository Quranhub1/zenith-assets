                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {investments.filter(inv => {
                    const matchesSearch = !searchQuery || 
                      ...
                      (inv.packageName && inv.packageName.toLowerCase().includes(searchQuery.toLowerCase())) ||
                    ...
                    <tr key={inv.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{inv.packageName || inv.plan || 'N/A'}</td>
